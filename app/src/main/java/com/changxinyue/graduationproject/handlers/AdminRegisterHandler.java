...
public class AdminRegisterHandler extends Handler {

    private Context context;
    private ServiceConnection serviceConnection;

    public AdminRegisterHandler(Context context, ServiceConnection serviceConnection) {
    ...
    public void handleMessage(Message msg) {
        switch (msg.what){
            ...
            case ProjectProperties.REGISTER_SUCCESS:
                ...
                ((AdminRegisterActivity)context).finish();
                break;
