...
public class SearchManager {
    ...
    public List<ScenicInfo> getScenicInfoList(String scenic_name) {
        MyOpenHelper myOpenHelper = new MyOpenHelper(context);
        SQLiteDatabase db = myOpenHelper.getWritableDatabase();
        List<ScenicInfo> scenicInfoList = new ArrayList<>();
        Cursor scenicInfoCursor = db.query("scenicInfo", null, "scenic_name like ?", new String[]{"%" + scenic_name + "%"}, null, null, null);
